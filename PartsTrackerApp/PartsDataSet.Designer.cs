...
namespace PartsTrackerApp {
    ...
    public partial class PartsDataSet : global::System.Data.DataSet {
        ...
        public partial class PartsDataTable : global::System.Data.TypedTableBase<PartsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public PartsRow AddPartsRow(string Name, string Part_Number, string Location) {
...
namespace PartsTrackerApp.PartsDataSetTableAdapters {
    ...
    public partial class PartsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Parts] ([Name], [Part Number], [Location]) VALUES (@Name, @Par" +
                "t_Number, @Location);\r\nSELECT Id, Name, [Part Number], Location FROM Parts WHERE" +
                " (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Parts] SET [Name] = @Name, [Part Number] = @Part_Number, [Location]" +
                " = @Location WHERE (([Id] = @Original_Id));\r\nSELECT Id, Name, [Part Number], Loc" +
                "ation FROM Parts WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::PartsTrackerApp.Properties.Settings.Default.PartsConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, [Part Number], Location FROM dbo.Parts";
        ...
        public virtual int Insert(string Name, string Part_Number, string Location) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Part_Number, string Location, int Original_Id, int Id) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Part_Number, string Location, int Original_Id) {
            return this.Update(Name, Part_Number, Location, Original_Id, Original_Id);
        }
    }
